(function ($) {
  ...
  console.log(products[0].customerRetentionRateEntities);

  for (let i = 0; i < products[0].customerRetentionRateEntities.length; i++) {
    for (let j = 0; j < quarters.length; j++) {
      // console.log(products[0].customerRetentionRateEntities[i]);
      quartersYears.push(
        products[0].customerRetentionRateEntities[i].yearStatistic.year +
          " " +
          quarters[j]
      );
      switch (j) {
